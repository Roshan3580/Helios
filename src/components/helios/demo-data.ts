export const TRACES = [
  {
    id: "trc_8f2a31e",
    app: "agent.research_assistant",
    query: "What changed in the Q3 revenue policy?",
    model: "gpt-4o",
    lat: 1420,
    cost: 0.018,
    tok: 2341,
  ...
  },
  {
    ...
    query: "Is there a SOC2 type II report available?",
    model: "claude-3.5",
    lat: 1810,
    cost: 0.014,
    tok: 2003,
  ...
  },
  {
    id: "trc_ee21d04",
    app: "agent.research_assistant",
    query: "Summarize the changelog for v1.2.",
    model: "gpt-4o",
    lat: 612,
    cost: 0.006,
    tok: 1102,
  ...
  },
  {
    id: "trc_6b81a02",
    app: "agent.research_assistant",
    query: "Diff between prompt v2 and v3.",
    model: "claude-3.5",
    lat: 1502,
    cost: 0.013,
    tok: 1888,
  ...
  },
  {
    id: "trc_3f9c211",
    app: "agent.support_router",
    query: "Why am I getting 429 on the eval API?",
    model: "gpt-4o",
    lat: 720,
    cost: 0.005,
    tok: 932,
