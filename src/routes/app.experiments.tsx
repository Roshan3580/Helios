...
const EXPS = [
  {
    name: "exp_router_security_intent",
  ...
  {
    name: "exp_rag_reranker_cohere_v3",
...
function ExperimentsPage() {
  return (
    <div>
        ...
        {EXPS.map((e) => (
          ...
          >
            ...
            <div className="col-span-1 flex justify-end">
              <StatusBadge
                tone={
                  e.status === "winning" ? "success" : e.status === "regressed" ? "danger" : "info"
                }
              >
                {e.status}
              </StatusBadge>
      ...
      <div className="mt-8">
        <Eyebrow>Sample data · for preview only</Eyebrow>
      </div>
    </div>
  );
}
